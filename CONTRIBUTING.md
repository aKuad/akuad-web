...
| ----------- | ---------- | -------------- | ------------------------------------- |
| `app`       | `tg/app`   | Application    | TS code editing                       |
| `page`      | `tg/page`  | Page           | HTML/CSS/JS code editing              |
| `doc`       | `tg/doc`   | Documentation  | Document (e.g. `README.md`) editing   |
...
| Location          | Items                                 |
| ----------------- | ------------------------------------- |
| `pages/global`    | Static files of site page             |
| `pages/functions` | Page API script on Cloudflare workers |
| `workers`         | Cron script on Cloudflare workers     |
